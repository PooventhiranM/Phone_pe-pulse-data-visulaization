...
if SELECT == "Home":
    ...
    col1.image(Image.open(r"C:\Users\poove\Downloads\about_phonepe2.jpg"),width = 300)
    with col1:
    ...
    with col2:
        st.video(r"C:\Users\poove\Downloads\upi.mp4")
...
# EXPLORE DATA - TRANSACTIONS
    if Type == "Transactions":
        ...
        with col1:
            ...
            df2 = pd.read_csv(r"C:\Users\poove\Downloads\Statenames.csv")
            df1.State = df2
...
if SELECT == "About":
    col1,col2 = st.columns(2)
    with col1:
        st.video(r"C:\Users\poove\Downloads\pulse-video (1).mp4")
    with col2:
        st.image(Image.open(r"C:\Users\poove\Downloads\about_phonepe2.jpg"),width = 500)
        st.write("---")
